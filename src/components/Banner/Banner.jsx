  ...
  return (
    <>
      <div className="container py-14 relative">
            ...
            <div data-aos="fade-up" data-aos-delay ="500"  className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-10">
              <div>
                <p>
                  ...
                  Our healthy meal plan delivery service Good 
                  Food in Miami is the answer for those who want to eat healthily, saving time for buying food and preparing delicious, healthy meals.
                </p>
              </div>
              <div></div>
            </div>
        ...
        {/* bg fruits  */}
        <div data-aos="fade-right"  className="absolute top-5 -left-16 sm:bottom-0 sm:left-0
        opacity-50 sm:opacity-100 ">
          <img data-aos="fade-right"  src={leaf} alt=""
        ...
        opacity-50 sm:opacity-100">
         ...
         <div data-aos="fade"  className="absolute top-1/2 -translate-y-1/2 left-1/3 -translate-x-1/2
        opacity-50 sm:opacity-100">
          <img src={kiwi} alt=""
